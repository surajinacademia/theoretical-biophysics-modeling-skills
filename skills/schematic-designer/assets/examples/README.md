...
[lesson selector](../../references/tutorials.md#choose-the-relevant-lesson) to
choose by communication problem. Each case's **Design lesson** explains its
useful choice and limits. Generated TeX and intermediate panels stay in build
output; maintained `figures/` folders contain only final library pairs.
