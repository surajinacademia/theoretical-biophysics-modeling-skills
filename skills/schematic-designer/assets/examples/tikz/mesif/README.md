...
```sh
python3 scripts/build_example.py tikz-mesif --output-dir /tmp/tikz-mesif
```
...
python3 skills/schematic-designer/scripts/render_tikz.py skills/schematic-designer/assets/examples/tikz/mesif/source.tex --include /tmp/schematic-minimalist/minimalist-profile.sty --engine lualatex --output-dir /tmp/tikz-mesif --basename figure
```
